...
<html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="../favicon.ico"> 
        	<!-- background -->
		<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/style4.css" />" />
    ...
    <body data-spy="scroll" data-target=".navbar-custom">
		...
		<div id="featured" class="fullSection">
			<div class="container">
				...
				<!-- featured-modal -->					
				<div class="modal fade" id="featured-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" style="width:50%;" aria-hidden="true">
				  <div class="modal-dialog modal-lg" style="width:100%; heigth:100%">
					<div class="modal-content">
					  <div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
